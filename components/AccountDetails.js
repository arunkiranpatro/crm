...
const Details = function({label,value,ccicon="false"}){
  ...
  <div>
    ...
    {
      ccicon==="true" && <i className="cc-icon"><FaCopy /></i>    }
  </div>
  );
...
export default class AccountDetails extends Component {
  ...
  render() {
    ...
    if(this.state.loading){
      ...
      body =(<>
          <div className="col">
              <Details label="Account Number" value={results.AccountNumber} ccicon="true"/>
              <Details label="Primary Email" value={results.PrimaryEmail} ccicon="true"/>
